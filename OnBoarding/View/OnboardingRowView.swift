...
#Preview {
    OnboardingRowView(onboardingData: OnboardingDataModel(image: UIImage(named: "Onboarding_1")!, title: "Quick actions directly from the powerful smart search", description: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the"), width: 350, height: 800)
}
